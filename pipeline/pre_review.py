...
def cmd_adjudicate(run_id: str) -> None:
    ...
    for i in range(0, len(cases), 5):
        ...
        payload = (
            ...
            "JUDGED FROM THE PROPERTY OWNER'S RIGHT TO LET, never the occupant's "
            "interests — favorable = the owner's liberty to let recognized, "
            "protected, or assumed lawful; adverse = regulation/restriction of "
            "letting upheld OR occupant/tenant rights expanded against the owner "
            "(rent control, eviction protection, statutory tenancy, habitability "
            "duties) — pro-tenant is NOT favorable; mixed; irrelevant. "
            "characterization: how the COURT classified the "
